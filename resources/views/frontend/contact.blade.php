                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    {{-- <form> --}}
                        ...
                        {!! Form::open([
                            ...
                            'role' => 'form',
                            'class' => 'contact_form',
                            'classenctype' => 'multipart/form-data',
                        ]) !!}
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    {{-- <input type="text" class="form-control" id="name" placeholder="Your Name"> --}}
                                    {!! Form::text('name', 'ddd', ['name'=> 'text_input', 'id'=> 'text_field', 'placeholder'=> 'Enter your name', 'class'=> 'form-control']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    {{-- <input type="text" class="form-control" id="name" placeholder="Your Name"> --}}
                                     {!! Form::select('country', ['1'=>'india','2'=>'canada'],'1', ['name'=>'country', 'id'=>'country_field', 'class'=>'']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
